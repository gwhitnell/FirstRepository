...
# define params
params = {"symbol": finnhubticker, "resolution": finnhubresolution, "token": finnhubkey}
...
# export to file
stock_df.to_csv(
    r"{0}\{1}_SupportResistance_{2}_{3}.csv".format(
        finnhubexportdir, rundate, finnhubticker, finnhubresolution
    ),
    index=None,
    header=True,
)
